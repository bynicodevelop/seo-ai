...
import { Article, SiteEntity } from '../types';
...
describe('article', () => {
    describe('createArticleToCategory', () => {
        let mockAdd: any;
        ...
        it('should create article in category for existing site by ID', async () => {
            const siteId = 'siteId';
            ...
            await createArticleToCategory(article, categoryId, siteId, db);

            expect(getSiteByIdSpy).toHaveBeenCalledWith(siteId, db);
        ...
        it('should create article in category for existing site by DocumentData', async () => {
            ...
            await createArticleToCategory(article, categoryId, site, db);
        ...
        it('should throw an error if site is not found', async () => {
            ...
            await expect(createArticleToCategory(article, categoryId, siteId, db)).rejects.toThrow("Site not found");
        ...
        it('should throw an error if there is an issue adding the article', async () => {
            const site = { ref: mockSiteDoc } as DocumentData;
            const categoryId = 'categoryId';
            const article: Article = {
                title: {
            ...
            await expect(createArticleToCategory(article, categoryId, site, db)).rejects.toThrow('Add article failed');
